...
import InternationalEnqueryForm from "../../components/f99/enquiry/enquiryInternational";
...
const InternationalEnquery = () => {
  return (
    <>
      <Script src="/js/hotjar.js" strategy="afterInteractive" />
      <Head>
        <title>F77 Enquiry Ultraviolette</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://www.ultraviolette.com/f99/enquiry"
        />
        <GraphTags
...
export default InternationalEnquery;
