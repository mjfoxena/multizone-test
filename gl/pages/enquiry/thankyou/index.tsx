  ...
  return (
    <>
      ...
      <Head>
        <link
          rel="canonical"
          href="https://www.ultraviolette.com/enquiry/thankyou"
        />
        <GraphTags
      ...
      <ThanksBar>
          ...
          <div className="flex flex-col">
            ...
            <div
              className={MapCss(
                Style,
                "brutal",
                "text-xs font-normal mt-7 sm:mt-10  sm:text-base"
              )}
            >
              <div className="mb-5">
                Thank you for submitting the enquiry! We will get back to you.
              </div>
            </div>
            {/* button */}
          </div>
        ...
        <Link href="/">
          {
            <div className={MapCss(Style, "procced")}>
              <div className={Style.proccedText}>EXPLORE THE F77</div>
              <Image
                alt="arrow-right"
                width={20}
                height={20}
