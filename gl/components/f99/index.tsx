...
const F99Enquiry = ({ imageUrl }) => {
    ...
    return (
        <div className={Style.reserve}>
            ...
            <div className="flex flex-col sm:mt-[53px] sm:pl-[10px] lg:pl-[20px] xl:pl-[40px]">
                <div className={Style.spotText}>F99</div> 
                <div className={`${Style.subReserve} sm:mr-16 lg:mr-0`}>
                ...
                <div className="">
                    ...
                    <div className="xl:-mt-3 hidden xl:block">
                        <div className={Style.arrowText}>
                            {">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>"}
                        </div>
                    </div>
                    <div className="xl:-mt-3 sm:-mt-14">
                        <div className={Style.arrowText}>
                            {">>>>>>>>>>>>>>>>>>>>>>>>"}
                        </div>
                    </div>
