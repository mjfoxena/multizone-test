                  ...
                  {title === "SUPER SONIC PERFORMANCE" && (
                    <div className="absolute top-4 right-4 flex flex-col gap-0 justify-center items-center">
                      <div className="text-black text-[10px]">
                        {/* {currentTab?.category} */}
                        {currentTab.category === 'RANGE' ? `${currentTab.category} (IDC EST.)` :`${currentTab.category}`}
                    ...
                    {currentTab.category !== data.category ? (
                      ...
                      >
                        {/* {data.stat !== ""
                          ...
                          : ""} */}
                           {data.stat !== "" && data.category === 'RANGE' ? `(IDC:${data.stat} ${data.statUnit})` : (data.stat !== "" ? `(${data.stat} ${data.statUnit})` : "")}
