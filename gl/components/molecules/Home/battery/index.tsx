  ...
  return (
    <div className={Style.batterySection} ref={batteryRef}>
      ...
      >
        ...
        <p className={Style.designText}>INCREDIBLE RANGE OF <span className="text-[#ED1C24] font-extrabold">323 KM </span><span className="text-[18px] text-[#ED1C24] font-extrabold">(IDC est.)</span></p>
      </motion.div>
