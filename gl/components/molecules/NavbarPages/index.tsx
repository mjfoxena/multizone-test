...
import { ConstRoutes } from "../../../constants/constRouter";
import { getUserMetaData } from "../../../services/helper";
...
export const NavbarPages = () => {
  ...
  const navItemsMobile = [
    {
      index: "01",
      title: "F77",
      href: `${originURL}${ConstRoutes.F77}`,
      selected: "",
    },
    // {
    //   index: "02",
    ...
    // },
    {
      index: "02",
      title: "SMART TECH",
      href: `${originURL}${ConstRoutes.SMARTTECH}`,
      selected: "smarttech",
    },
    // {
    //   index: "03",
    ...
    // },
    {
      index: "03",
      title: "UV RACING",
      href: `${originURL}${ConstRoutes.F99}`,
      selected: "f99",
    },
    {
      index: "04",
      title: "ABOUT",
      href: `${originURL}${ConstRoutes.ABOUT}`,
      selected: "squadron",
    },
    {
      index: "05",
      title: "CONFIGURE",
      href: `${originURL}${ConstRoutes.CONFIGURE}`,
      selected: "configure",
    },
    // {
    //   index: "06",
    //   title: "CAREERS",
    //   href: `${originURL}${ConstRoutes.CAREERS}`,
    //   selected: "careers",
    // },
    {
      index: 6,
      title: userData?.email ? "PROFILE" : "SIGN IN",
      href: userData?.email ? `${originURL}/gl/profile` : `${originURL}/signin`,
    ...
    },
    {
      index: "08",
      title: "CONTACT",
      href: `${originURL}${ConstRoutes.CONTACT}`,
      selected: "contact",
    },
    {
      index: "09",
      title: "FAQ",
      href: `${originURL}${ConstRoutes.FAQ}`,
      selected: "faq",
    },
    {
      index: "10",
      title: "PRESS",
      href: `${originURL}${ConstRoutes.PRESS}`,
      selected: "press",
    },
  ];
  ...
  const NavAllItems = [
    ...
    },
    {
      index: 4,
      title: "ABOUT",
      href: `${originURL}${ConstRoutes.SQUADRON}`,
      selected: "squadron",
    },
    {
      index: 5,
  ...
  const shouldNavbarBeFixed = router.pathname.startsWith("/gl/configure");

  const font_Size = isMobile ? 12 : 11;
  const marginTopClass = font_Size === 12 ? "-mt-1" : "";

  const testRideText =
    reqCountry === "IN" ? "REGISTER YOUR INTEREST" : "REGISTER YOUR INTEREST";
  const testRideUrl =
    reqCountry === "IN" ? "enquiry_international" : "enquiry_international";
        ...
        <>
          ...
          >
            ...
            <div className={Style.navItemsWrapper}>
              {!sidebarOpen &&
                navItemsMobile.splice(0, 5).map((eachItem, ind) => (
                  <Link
                    href={eachItem.href}
                    key={ind}
