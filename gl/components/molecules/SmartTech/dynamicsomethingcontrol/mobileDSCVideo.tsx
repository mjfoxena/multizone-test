...
export default function MobileDSCVideo() {
  ...
  return (
    <div className="md:block max-md:visible pl-[5%] max-md:pl-0 max-md:mt-[3.313rem]  max-md:self-center  relative">
      <div className="w-[370.163px]  md:hidden relative flex items-center justify-center">
        <video
          ref={videoRef}
          playsInline
          autoPlay={false}
