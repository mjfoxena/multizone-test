...
const ThankYou = () => {
  return (
    <>
      ...
      <Head>
        <link rel="canonical" href="https://www.ultraviolette.com/thanks" />
        <GraphTags
          title="Ultraviolette Test Ride | Experience Our Electric Vehicles"
          description=""
          image=""
          url="https://www.ultraviolette.com/thanks"
        />
      </Head>
      <ThanksBar>
        <div className="flex flex-col ml-7 mr-7 mb-20 sm:ml-16 sm:pt-8 sm:mb-40 sm:mr-20 justify-between">
          <div className="flex flex-col">
            ...
            <div className={MapCss(Style, "brutal", 'text-xs font-normal mt-7 sm:mt-10  sm:text-base')}>
              <div className='mb-5'>
                We are thrilled to inform you that your test ride experience for the F77 is confirmed! Someone from our team will get back to you shortly.
              </div>
            </div>
            {/* button */}
          </div>
