...
const CommonScrollCategories = ({ selectedModel, selectedDetails }) => {
    ...
    return (
        <div>
            <div style={{ letterSpacing: "0.2px" }}>
                ...
                <p className='text-[12px] sm:text-[14px] brutal font-normal sm:mt-4 mt-3 leading-[17px] tracking-[0.2px]'>{selectedDetails?.category_desc}</p>
            </div>
...
export default CommonScrollCategories