...
const CommonFooter = () => {
  ...
  useOutsideClick(sidePanelRef, () => {
    setSidebarTab((e) => {
      if ([sidebarSteps.rolloutCal].includes(e)) {
  ...
  return (
    ...
    >
      <div className="w-full h-full max-w-[1366px] ">
        ...
        <div className="w-full flex flex-col p-6 xl:w-[85%] xl:flex-row xl:justify-between   xl:pt-10 xl:pb-10 xl:ml-20 xl:mr-20 xl:pl-0 xl:pr-0 ">
          <div className="xl:flex-col  justify-between  ">
            ...
            <div
              className={MapCss(
                Style,
                "footerDesc",
                "flex justify-between items-start xl:flex-col xl:mt-12 md:mb-10"
              )}
            >
              <div
                className={`${
          ...
          <div
            ...
            }  mt-2 mb-2 xl:ml-12 xl:mr-12 xl:hidden`}
          ></div>

          <div className="flex  flex-col w-full xl:w-auto xl:flex-row  xl:gap-32 ">
        ...
        {footerTheme === "white" && (
          <div className="hidden xl:flex  h-auto border-b-2 border-grey mt-2 mb-2 xl:ml-20 xl:mr-20 "></div>
        )}
        <div className="xl:hidden pl-6 pb-4  flex flex-col gap-2 ">
          <div
        ...
        <div className="hidden xl:flex xl:ml-20 xl:mr-20 items-center gap-6 w-fit ">
          <div
            className={`${Style.footerText} ${
              footerTheme === "black" ? "text-[#DBDBDB]" : "text-[#565656]"
            } w-fit`}
          ...
          <div
            className={`${Style.queriesContact} ${
              footerTheme === "black" ? "text-[#DBDBDB]" : "text-[#565656]"
            } w-fit hidden xl:flex justify-center items-center`}
          >
            For any queries please reach out to us on{" "}
            <strong
              className={` ${
