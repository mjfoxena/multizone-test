  ...
  return (
    <div className="w-full h-[27.875rem] flex justify-center  relative">
      ...
      <div className="absolute w-full h-full flex flex-col justify-start items-start max-w-[77.813rem] max-md:max-w-[21.188rem]">
        ...
        {/* <div className="absolute top-1/2 right-40 transform -translate-x-1/2 -translate-y-[70%] max-md:hidden">
          <h2 className="text-center text-2xl font-normal brutal leading-[20px] text-[#FFF]">
            INDIA
          </h2>
        </div> */}
