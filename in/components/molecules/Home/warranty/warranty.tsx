        ...
        <div className=" w-full h-full hidden sm:flex ">
          {playVideo && (
            <VideoPlayer
              ...
              loop={false}
              src={
                "https://player.vimeo.com/external/936957321.m3u8?s=aa13a13796a12707001cec46c37b78e80d356af4&logging=false"
              }
            />
          )}
        </div>
        ...
        <div className="sm:hidden flex  w-full h-full mt-12">
          {playVideoMob && (
            <VideoPlayer
              ...
              loop={false}
              src={
                "https://player.vimeo.com/external/936957281.m3u8?s=bfcf960340a1156774cf73401f8a48303ef7624b&logging=false"
              }
            />
          )}
        </div>
