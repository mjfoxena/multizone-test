  ...
  return (
    <div className={Style.jet}>
      <div className="relative w-full h-full ">
        <div className="hidden xl:flex  w-full h-full  relative overflow-hidden ">
          <video
            ref={videoOneRef}
            muted={muted}
            playsInline
        ...
        <div className="xl:hidden w-full h-full relative overflow-hidden">
          <video
            ref={videoOneRefmob}
            muted={muted}
            playsInline
        ...
        {!showPlayButton && (
          <motion.div
            ...
            className="flex justify-center items-center  gap-4  absolute bottom-44 xl:bottom-[8%] w-full  "
          >
            <div
