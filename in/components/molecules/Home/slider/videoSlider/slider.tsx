...
const Slider = ({ title, desc, isMobile, videoId, duration }: SliderProps) => {
  ...
  return (
    <div className="flex flex-col gap-4 xl:gap-4 2xl:gap-5 items-start h-full xl:h-full min-w-[90%] xl:min-w-[52%]  cards">
      <div className="relative  rounded-[1px] w-[95%] xl:w-[95%] h-[50%] max-h-[50%] xl:h-[70%] xl:max-h-[90%]">
        {/* Video Player */}
        <iframe
          ref={iFrameRef}
          title={title}
