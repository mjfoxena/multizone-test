...
const SmartTech = () => {
  ...
  return (
    <div className={Style.smartTech}>
      <div className="h-screen  max-h-[550px] md:max-h-[500px] xl:h-[60vh] xl:max-h-[360px] xl:mt-12 w-full p-6 xl:p-0  xl:w-[80%] md:p-6  flex flex-col xl:flex-row justify-start gap-32 xl:justify-between items-center xl:items-start">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0, transition: { duration: 1 } }}
          viewport={{ once: true }}
          className={`${Style.mainTitle} mt-24  h-fit xl:mt-12 2xl:mt-0 `}
        >
          ...
          <p className={Style.smartechText}>
            ...
            <span className="xl:hidden">SMART TECH</span>
          </p>
        </motion.div>
        <div className="xl:w-[42%]  xl:h-[65%] 2xl:h-[85%]  2xl:w-[35%] xl:mt-12 2xl:mt-0 flex flex-col xl:justify-around  gap-4 xl:mr-[2%] ">
          <motion.p
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0, transition: { duration: 1 } }}
            viewport={{ once: true }}
          ...
          >
            The UV smart tech powered by Violette A.I., is loaded with all the
            essentials & beyond that helps you and your motorcycle be secure,
            safe and fast! You’re never alone in your sortie when on an F77 MACH
            2.
          </motion.p>
          <div
            onClick={() => router.push("/smarttech")}
            className={`${Style.learnMore} cursor-pointer z-50`}
          >
            Learn more
            <svg
      ...
      >
        <div className="w-full absolut bottom-0 left-0 hidden xl:w-full overflow-hidden xl:flex justify-center items-end  h-[600px] max-h-[300px] xl:h-fit xl:max-h-full ">
          <ImageHotSpot />
        </div>

        <div className="w-full xl:hidden md:mt-[40%] xl:mt-0  flex justify-center items-end h-[350px]">
          <ImageHotSpot />
        </div>
      </div>
