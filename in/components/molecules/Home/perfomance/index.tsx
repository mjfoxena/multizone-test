  ...
  return (
    ...
    >
      ...
      <div className={Style.headWrapper} ref={categoryRef}>
        <div className=" flex  w-full  justify-center items-center  flex-col xl:flex-row xl:justify-start xl:items-start gap-0  xl:gap-0  h-full  xl:w-[40%]  ">
          {/* mobile image section */}

          <div className="w-full xl:hidden flex  md:pb-2">
            <h1
              className={`${Style.titleMobile} xl:hidden    pl-6  pr-6  xl:pl-0 xl:pr-0`}
            >
              {title}
            </h1>
          </div>
          ...
          <div
            className={`flex flex-col xl:hidden w-full ${
              title === "SMART RIDE" ? "h-[40%] " : "h-[45%]"
            } justify-center items-center  `}
          >
            <div
              className={` h-full w-full  max-h-[300px] md:max-h-[400px] overflow-hidden pl-6 md:pl-0 md:pr-0 pr-6 xl:pl-0 xl:pr-0`}
            >
              <div
                className={`${Style.imageTransitionMobile} h-full relative  w-full overflow-hidden rounded-[1px] shadow-md`}
              >
                <div
                  className={`absolute  w-[100%] md:max-w-[97%] xl:max-w-[100%]  ${
                    title === "SMART RIDE" ? "top-0 " : "top-0"
                  }  xl:hidden flex justify-center items-center md:pl-6 xl:pl-0`}
                >
                  <LinearProgressBar />
                </div>
                <div className="w-full h-full md:max-w-[97%] xl:max-w-[100%] flex justify-center items-center relative">
                  {currentTab?.videoUrl !== "" ? (
                    <video
                      ref={videoRefMob}
                      autoPlay={true}
                  ...
                  {title === "SUPER SONIC PERFORMANCE" && (
                    <div className="absolute top-4 right-4 flex flex-col gap-0 justify-center items-center">
                      <div className="text-black text-[10px]">
                        {/* {currentTab?.category} */}
                        {currentTab.category === "RANGE"
                          ? `${currentTab.category} (IDC EST.)`
                          : `${currentTab.category}`}
                      </div>
          ...
          <motion.div
            className={`w-full flex flex-col  justify-start gap-1 xl:gap-0  ${
              title === "SMART RIDE" ? "h-[40%]" : " h-[45%] "
            } xl:h-[82%] relative  pl-6 pr-6 xl:pl-0 xl:pr-0"`}
          >
            <div className="hidden w-full  xl:flex h-[15%] justify-between items-start">
              <motion.h1
                variants={{
            ...
            <div
              className={`w-full h-full  ${
                title === "SMART RIDE" ? "xl:h-[65%]  " : " xl:h-[61%]"
              } flex flex-col gap-4 md:gap-5 md:mt-2  xl:gap-10 2xl:gap-12 z-50`}
            >
                  ...
                  >
                    ...
                    {currentTab.category !== data.category ? (
                      <motion.div
                        ...
                        onClick={() => setCategory(data)}
                      >
                        {data.stat !== "" && data.category === "RANGE"
                          ? `(IDC:${data.stat} ${data.statUnit})`
                          : data.stat !== ""
            ...
            <div className="w-full h-[15%] xl:h-fit z-50  xl:absolute -bottom-[9px] left-0 ">
              {title === "SUPER SONIC PERFORMANCE" ? (
                <a
                  className={`${Style.downloadSpec} pt-4 xl:pt-0 md:pt-10`}
