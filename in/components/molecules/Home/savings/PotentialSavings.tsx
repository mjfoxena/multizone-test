  ...
  return (
    <div
      className={` sm:h-full  flex  flex-col gap-3 sm:gap-8  ${
        isConfigurator ? "xl:-mt-6" : "xl:-mt-8"
      }`}
    >
      {/* result */}
      <motion.div
      ...
      >
        <p className={`${Style.savingsH} xl:hidden`}>SAVINGS</p>
        <p className={`${Style.savingsH} hidden  xl:block`}>
          CALCULATE YOUR
      ...
      <div className=" overflow-x-hidden overflow-y-hidden text-white relative  ">
        <div className="flex flex-col gap-6 sm:gap-8">
          ...
          {/* Cost Of Fuel */}
          <div className="flex mt-8 justify-between xl:justify-start">
            <div
              className={`sm:flex-initial w-fit xl:w-[30%] self-center text-sm sm:font-normal brutal ${
                isConfigurator ? "sm:text-[18px]" : "sm:text-[18px]"
              }`}
            >
              Cost of fuel (₹/L)
            </div>
            <div className="sm:flex xl:w-[25%]  justify-center items-center">
              <NumberCounter
                min={90}
                max={180}
          ...
          {/* Number of years */}
          <div className="flex mt-0  xl:mt-7 justify-between xl:justify-start">
            <div
              className={`sm:flex-initial w-fit xl:w-[30%] self-center text-sm sm:font-normal brutal ${
                isConfigurator ? "sm:text-[18px]" : "sm:text-[18px]"
              }`}
            ...
            <div className="xl:flex xl:w-[25%] justify-center  ">
              <NumberCounter
                min={1}
                max={10}
        ...
        {/* Divider */}
        {/* Calender footer */}
        <div className="xl:absolute bottom-0 right-0 sm:w-fit mt-4 sm:mt-0 ">
          <div className={Style.desc}>
            <p> *The mentioned values are approximate.</p>
          </div>
        </div>
      </div>
    </div>
