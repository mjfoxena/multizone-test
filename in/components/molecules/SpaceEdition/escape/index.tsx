      ...
      <div>
        ...
        <div className="mt-[0] sm:mt-[21px]">
          <div className="hidden sm:flex sm:flex-col">
            ...
            >
              A testament to the world of aerospace and aviation.
            </motion.div>
            <motion.div
              ref={refMoon}
              variants={boxVariant}
            ...
            >
              <div>Led by the philosophy of being Bold, Progressive and Future Driven.</div>
              <div>
                Deep rooted in the principles of aerospace engineering and uncompromising performance.
              </div>
              <div>
              The ideology of functional honesty.
              </div>
            </motion.div>
          </div>
          <div className="flex flex-row sm:hidden">
            ...
            >
              The space edition F77 is not a motorcycle, it is a statement. A
