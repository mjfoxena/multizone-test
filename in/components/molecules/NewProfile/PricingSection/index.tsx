...
export default function PicingSection({ profileDetails }: AccountDetailsProps) {
  ...
  return (
    <div className="w-full   flex flex-col items-center justify-center bg-black  ">
      <div className="w-full flex justify-start items-start   max-w-[70%]  max-md:max-w-[85%] 2xl:max-w-[60%] h-full ">
          ...
          <div className="flex justify-between max-md:w-full">
            <div className="max-w-[39.938rem]  flex flex-col w-full h-full mt-[1.563rem] justify-start items-start">
              ...
              <div className="mt-[3.625rem] max-md:mt-[2.900rem] w-full flex flex-col">
                ...
                <div className="flex flex-col w-full mt-[2.438rem] max-md:mt-[3.125rem] gap-[1.938rem]">
                  ...
                  {Number(
                    ...
                    <div>
                      ...
                      <div className="flex justify-start items-start text-gray-400 brutal text-[12px] font-normal  tracking-wide max-md:tracking-[0.2px] max-md:max-w-[14.813rem]">
                        <h1 className="leading-[21px] max-md:leading-[20px]">
                          {
                            profileDetails.booking_details.model_data
                  ...
                  <div className="mt-[1.000rem]  max-md:mt-[1.500rem] w-full flex flex-col">
                    ...
                    <div className="flex w-full justify-end">
                      ...
                      <h1 className="text-white text-right brutal text-[12px] font-normal leading-[21px] tracking-wide max-md:hidden">
                        EMI <span>&#8377;</span> {formattedEMI}/Month
                      </h1>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col w-full mt-[1.375rem] mb-[9.313rem] max-md:mb-[3.125rem]">
                  ...
                  <div
                    onClick={() => signOut()}
                    className=" brutal cursor-pointer  flex mt-[3.063rem] items-start md:hidden"
                  >
                    <h1 className="text-[12px]  text-white brutal font-medium leading-[34px] tracking-[0.2px]">
                      SIGN OUT
                    </h1>
                    <Image
            ...
            <div className="h-[32.063rem] w-[11.000rem] max-md:hidden">
              <Image
