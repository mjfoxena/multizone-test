...
export default function VioletteEnabledTech() {
  ...
  return (
    <div
      ref={animationRef}
      className=" w-full mt-[7.438rem] md:pl-20 xl:pl-0  max-sm:mt-[0rem] flex justify-center md:justify-end md:items-end xl:items-start xl:justify-center items-start max-sm:flex-col md:flex-col xl:flex-row relative"
    >
      <div className="flex 2xl:mr-[7%] max-sm:flex-col flex-row justify-end md:justify-start   xl:justify-end w-full md:max-w-[70rem] max-sm:max-w-full xl:max-w-[71.00rem] ">
        <motion.div
          ref={animationRef}
          initial="hidden"
        ...
        >
          <div className="flex  flex-col gap-5 md:pl-0  max-sm:justify-center max-sm:items-center  ">
            <div>
              <h1 className="max-sm:mt-[5.688rem] max-sm:mb-5  text-white brutal text-[2rem] max-sm:text-[1.000rem] font-normal leading-[2.25rem] max-sm:leading-[1.875rem] max-w-[29.313rem] xl:max-w-[29.313rem] md:max-w-[44.313rem] max-sm:max-w-[16.813rem] max-sm:text-center">
                Violette watches over your motorcycle while you’re off duty.{" "}
              </h1>

              <p className="text-[#C7C0D2] max-sm:hidden   max-w-[25.000rem] max-sm:mt-[1.875rem] mt-[2.000rem] max-sm:mb-[6.938rem] max-sm:text-center  brutal text-[1.000rem] font-normal leading-[1.375rem] max-sm:leading-[1.500rem] opacity-80  ">
                Violette A.I. will always keep your F77 Mach 2 connected to our
                servers - even with the key off*
              </p>
              <p className="text-[#C7C0D2]  md:hidden max-w-[17.688rem] mt-[0.875rem]  max-sm:text-center  brutal text-[0.750rem] font-normal leading-[1.375rem] max-sm:leading-[1.250rem] opacity-80  ">
                Violette A.I. will always keep your F77 Mach 2 connected to our
                servers - even with the key off*
              </p>
            </div>
            ...
            <div className=" flex flex-col gap-[2.750rem] mt-[15%] max-sm:hidden ">
      ...
      <motion.div
        ...
        className="md:mt-16 xl:mt-0"
      >
        <div className="h-[600px] w-[800px] md:w-full xl:w-[800px] relative max-sm:hidden  xl:mt-0  xl:ml-0">
          <video
            autoPlay
            muted
            playsInline
