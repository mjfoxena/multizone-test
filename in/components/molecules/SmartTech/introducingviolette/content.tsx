...
export default function Content() {
  ...
  return (
    <div className="mt-[5.563rem] items-start flex w-full md:max-w-[85%] xl:max-w-full max-md:flex-col md:flex-col xl:flex-row flex-row justify-start max-md:justify-center max-md:items-center  ">
      {" "}
      ...
      >
        <div className="flex flex-col justify-start max-md:items-center ">
          ...
          {/* desktop */}
          <p className="max-md:hidden text-[#C7C0D2] brutal text-[14px] max-md:text-[0.750rem] max-md:text-center max-md:mt-[2.500rem] mt-[1.813rem] leading-6 z-10 w-[30.125rem] md:w-[40.188rem] xl:w-[30.125rem] max-md:w-[19.188rem]">
            Not only have we made a really powerful and fast motorcycle, we have
            also created the perfect co-pilot to help you handle all that the
            F77 MACH 2 offers and more. The future of performance motorcycles
            takes off with us.
          </p>
          {/* mobile */}
      ...
      >
        <div className="flex flex-col justify-start items-start  max-md:mt-[8.063rem] md:mt-[8.063rem] xl:mt-0 pl-[8.000rem] xl:pl-[8.000rem] md:pl-0  max-md:pl-0">
