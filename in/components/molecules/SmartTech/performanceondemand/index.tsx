...
export default function PerformanceOnDemand() {
  ...
  return (
    <div
      ref={animationRef}
      className="w-full h-full flex flex-col items-center justify-center bg-[#000] z-10 mt-[16.688rem] max-md:mt-[4.500rem] "
    >
      <div className=" w-full md:max-w-[70rem] max-md:max-w-full xl:max-w-[71.00rem] max-md:items-center">
        ...
        >
          <div className=" max-md:mt-[3.688rem] mt-[5.125rem] relative items-center w-full flex flex-col justify-center">
