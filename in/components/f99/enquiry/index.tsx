...
const EnqueryF99Form = ({ nextHandlerTapped, className = "" }) => {
  ...
  const onSubmitHandler = async () => {
    ...
    router.push(`${originURL}/f99/enquiry/thankyou`)
  };
        ...
        <div className="">
          ...
          <div className="" style={{ marginTop: "26px" }}>
            ...
            <div className="" id="form">
              ...
              {/* Pincode */}
              {(selectedState || (selectedCountry && COUNTRIES_DATA[selectedCountry.value]?.states && Object.keys(COUNTRIES_DATA[selectedCountry.value].states).length === 0)) && (
                <div className="mt-7">
                  <TextFieldInput
