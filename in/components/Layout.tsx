    ...
    <div>
      ...
      <div className="w-full flex flex-col pt-4 pr-10 pb-4 pl-8 sm:w-full sm:flex-row sm:pt-12 sm:pl-0 sm:pr-12 sm:pb-5 sm:justify-around">
        <div className="sm:flex-col sm:mr-40 justify-between">
          ...
          >
            <p className="uppercase text-[#e85050] font-semibold underline">
              Sitemap
            </p>
          </div>
        ...
        <div className="flex flex-col w-full sm:w-auto sm:flex-row  sm:gap-40 sm:mr-12 sm:ml-[20px]">
          <div className="sm:flex sm:flex-col ">
            ...
            >
              <a href={`${originURL}/`} hrefLang="en-in">
                Home
              </a>
            </div>
            <div
            ...
            <div
              className={MapCss(Style, "brutal-subtext", "text-sm sm:text-lg")}
            >
              <a href={`${originURL}/configure`} hrefLang="en-in">
                Configure
              </a>
            </div>
            <div
              className={MapCss(Style, "brutal-subtext", "text-sm sm:text-lg")}
            >
              <a href={`${originURL}/f99`} hrefLang="en-in">
                F99
              </a>
            </div>
            <div
          ...
          <div className="sm:flex sm:flex-col ">
            ...
            <div
              className={MapCss(Style, "brutal-subtext", "text-sm sm:text-lg")}
            >
              <a href={`${originURL}/squadron`} hrefLang="en-in">
                Squadron
              </a>
            </div>
            ...
            <div
              className={MapCss(Style, "brutal-subtext", "text-sm sm:text-lg")}
            >
              <a href={`${originURL}/squadron/leaderboard`} hrefLang="en-in">
                Leaderboard
              </a>
            </div>
            <div
              className={MapCss(Style, "brutal-subtext", "text-sm sm:text-lg")}
            >
              <a href={`${originURL}/squadron/wallpaper`} hrefLang="en-in">
                Wallpaper
              </a>
            </div>
