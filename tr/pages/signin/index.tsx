    ...
    <>
      ...
      >
        <div className="flex flex-col ml-7 mr-7 pb-8 sm:pb-28  sm:ml-16 sm:pt-8  sm:mr-20 justify-between">
          ...
          {!enterOtp && (
            <div className="flex flex-row mt-[32px]  pb-10 mb-6 sm:mb-10   sm:mt-[16px]">
              <div className="flex flex-col">
                {/* Subscribe to official communication */}
              <div className="flex flex-row mt-[32px]  sm:mt-[16px]">
              <div className={Style.check}>
                <input
                  type="checkbox"
                  checked={subcheckbox}
                  onChange={() => setSubCheckbox((prev) => !prev)}
                />
                <span className={Style.checkmark}></span>
              </div>
              <div className={Style.checkboxText}>
              Subscribe to official communication, product launches, and new features updates. We won’t spam.
              </div>
            </div>
            {/* Terms of Use  */}
            <div className="flex flex-row mt-[32px]  sm:mt-[16px]">
