...
const TermsConditions = () => {
  return (
    <>
      <Head>
        <title>Ultraviolette Automotive | RSA Policy</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <link rel="canonical" href="https://www.ultraviolette.com/legal/rsa-policy" />
        <GraphTags
          title="Ultraviolette Automotive | RSA Policy"
          description="initial-scale=1.0, width=device-width"
          image=""
          url="https://www.ultraviolette.com/legal/rsa-policy"
        />
      </Head>
      ...
      <div className="flex flex-col sm:flex-col sm:w-screen">
        <div className="">
          <CommonHyperLinkViewer
            Subheading={"RSA POLICY"}
            Heading={"Ultraviolette RSA POLICY"}
            body={
              <div>
