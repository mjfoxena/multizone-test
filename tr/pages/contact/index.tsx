  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta name="description" content="Reach out to Ultraviolette for support, inquiries, or assistance with our electric vehicles and mobility solutions." />
            ...
            <div className=" flex flex-col w-full sm:pr-16 h-full">
              ...
              <div className="flex flex-col  w-full pl-7 mt-11 gap-16 sm:gap-20 sm:pl-0 sm:mt-24 sm:mb-36 sm:flex-row sm:ml-16">
                <div className="flex flex-col w-full sm:w-1/5">
                  ...
                  >
                    <a href="mailto:info@ultraviolette.com" hrefLang="en-in">info@ultraviolette.com</a>
                  </div>
                </div>
                <div className="flex flex-col ">
                  ...
                  >
                    <a href="mailto:careers@ultraviolette.com" hrefLang="en-in">careers@ultraviolette.com</a>
                  </div>
                </div>
