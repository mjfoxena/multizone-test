...
const Delivery = ({countryName}) => {
  ...
  const [country, setCountry] = useState({ ...initialFieldState, value: "TR" });
  ...
  useEffect(() => {
    if (country.value && country.value.length > 0 && country.value !== "TR") {
  ...
  const sendSmsOtp = async () => {
    ...
    requestPayload.phone_number = "+90" + phone.value;
  ...
  const verifyOTP = async (otpVal) => {
    ...
    requestPayload.username = "+90" + phone.value;
  ...
  // turkey picode validation
  const alphanumericPattern = /^[0-9]{5}$/;
  ...
  let countryCode = "+90"; // Default value  
        ...
        <div className="flex flex-col pb-20 sm:pb-0">
          ...
          <div className="mt-4 sm:mt-0 ">
            ...
            >
              ...
              <div
                onClick={() => {
                  if (!phone.error && phone.value.length === 10) {
                    setShowOtp(true);
                    sendSmsOtp();
                    setGetOtp(true);
                  }
            ...
            <>
              <div className="">
                <div className={Style.age}>
                  ...
                  <span className="hidden sm:inline">+90 {phone?.value}</span>
                </div>
              </div>
