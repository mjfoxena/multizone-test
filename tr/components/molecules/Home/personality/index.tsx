    ...
    <div className="w-full h-fit">
      ...
      <div className="w-full h-[100px] flex justify-center items-center">
         <motion.p initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0, transition: { duration: 1 } }} viewport={{ once: true }} className={Style.heading}>THE F77 MACH 2 <span className="text-[#ED1C24] font-extrabold">PERSONALITIES</span></motion.p>
      </div>
      ...
      {personalityTypes.map((personality) => (
        ...
        >
          ...
          <div
            className={`${Style.tag} ${
              ...
              selectedType === personality.type
                ...
                : "hidden sm:flex justify-around items-center  gap-4"
            }`}
          >
            {personality.tag}
          </div>
          <div className={Style.title}>
            {selectedType === personality.type && (
              <div className="w-8 sm:w-[30px] h-full  flex justify-center items-center">
              </div>
            )}
            <div className={`${Style.titlename} w-[135px]`}>
              ...
              <div className="sm:hidden flex  justify-between items-center w-[140px]">
                <Image
                  alt="vector-image"
                  width={8}
                  height={10}
