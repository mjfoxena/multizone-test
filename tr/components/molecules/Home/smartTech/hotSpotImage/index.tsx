...
const [specMob,setSpecMob] = useState('New Console Themes');
  ...
  return (
    <div className={Style.bike}>
      <div className=' hidden  sm:flex  w-full  h-fit justify-center items-center '>
            <div className='sm:relative w-[80%]  flex justify-center items-center  -mt-12'>
            <Image
            width={2000}
            height={2000}
            alt="f77"
          ...
          <div className='absolute top-[34%] left-[3%] z-50'>
          ...
          <div className='absolute top-[58%] left-[82%] z-50'>
      ...
      <div className=' sm:hidden relative w-full h-fit '>
      <div className={`${Style.mobIcon} absolute -top-[10%] left-1/2 transform -translate-x-1/2 -translate-y-1/2  w-fit backdrop-filter backdrop-blur-lg bg-opacity-30 firefox:bg-opacity-90 px-4 py-2 text-[#fff]`}>{specMob}</div>
      <Image
            width={2000}
            height={2000}
            alt="f77Mob"
          ...
          <SpotIconM title={'Delta Watch'} setSpecMob={setSpecMob} specMob={specMob}/>
          </div>
          <div className='absolute top-[47%] left-[52%]'>
          <SpotIconM title={'Crash Alert'} setSpecMob={setSpecMob} specMob={specMob}/>
          </div>
          <div className='absolute top-[15%] left-[63%]'>
          <SpotIconM title={'New Console Themes'} setSpecMob={setSpecMob} specMob={specMob}/>
          </div>
          <div className='absolute top-[60%] left-[79%]'>
          <SpotIconM title='Low Tyre pressure alerts' setSpecMob={setSpecMob} specMob={specMob}/>
          </div>
          <div className='absolute top-[15%] left-[10%]'>
          <SpotIconM title='Anti-Collision Warning System' setSpecMob={setSpecMob} specMob={specMob}/>
          </div>
          <div className='absolute top-[58%] left-[16%]'>
          <SpotIconM title='Remote lockdown' setSpecMob={setSpecMob} specMob={specMob}/>
          </div>
