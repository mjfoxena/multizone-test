...
const Details = () => {
  ...
  return (
    <div className={Style.details} ref={detailsRef}>
      ...
      <motion.div initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0, transition: { duration: 1 } }} viewport={{ once: true }} className={Style.headingM}>
        <p>
          <span className="text-[#ED1C24] font-extrabold">A NEW IDENTITY</span>{" "}
          FOR ELECTRIC
          {/* <br /> */}
      ...
      <div className="hidden sm:flex relative w-[80%]  sm:h-screen ">
        {/* section 1 */}
      ...
      <div className="sm:hidden relative w-full h-fit ">
        ...
        <div className="w-full h-[100vh]">
          <div className="w-full h-[25%] flex justify-start">
