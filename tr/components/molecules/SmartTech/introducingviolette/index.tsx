...
export default function IntroducingViolette() {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center bg-[#000] relative max-md:mt-[11.250rem]">
      {/* Background Image */}
      <div className="absolute top-[-12%] xl:top-[-10%] 2xl:top-[-10%] xl:left-[31%] 2xl:left-[35%] max-md:left-[-20%] max-md:top-[-17%] w-full h-full">
      ...
      {/* Main Content */}
      <div className="w-full md:max-w-[70rem] max-md:max-w-full xl:max-w-[71.00rem] flex flex-col justify-center items-center xl:mt-[7.688rem] md:mt-0">
        <div className="w-full flex flex-col justify-center items-center">
          <VioletteHeading />
          <h1 className="mt-5  max-md:left-[45%] text-center text-[#5B03EC] disketMono text-[20px] leading-normal uppercase  ">
            a.i.
          </h1>
      ...
      {/* Rotated Image */}
      <div className="absolute top-[30%] max-md:top-[25%] max-md:right-[-120%] xl:top-[40%] right-[-5%] 2xl:right-[-30%] xl:right-[-30%]  rotate-[-87.825deg] ">
        <Image
          src={
            "/images/smarttech/introducingViolette/indroducing_violete_right_sidebg.png"
          }
