    ...
    <>
      <div className="flex flex-row max-h-[220px] sm:max-h-[312px] items-start bg-grey5 sm:h-auto sm:min-w-[48%]">
        ...
        <div className="flex flex-col sm:h-auto w-[60%] sm:w-[48%] h-[220px] ml-[10px] sm:ml-5 mr-6 ">
          ...
          <div className="sm:h-[110px] pt-[11.8px] sm:pt-[22px] brutal text-[14px] sm:text-[28px] font-normal capitalize overflow-hidden"
          style={{
            display: "-webkit-box",
            WebkitLineClamp: 2,
          ...
          <div className="pt-2 sm:pt-6 ml-0">
            <a href={link} target="_blank" rel="noopener noreferrer" hrefLang="en-in">
              <Button
