...
export const NavbarPages = () => {
  ...
  const testRideText =
    reqCountry === "TR" ? "BOOK TEST RIDE" : "REGISTER YOUR INTEREST";
  const testRideUrl =
    reqCountry === "TR" ? "testride" : "enquiry_international";

  return (
    <div
      className={`w-full  transition-all duration-5000 ease-in-out ${
        shouldNavbarBeFixed || isScrollingUp ? 'fixed opacity-100 z-100 mb-0' : 'opacity-100 z-100' 
      }`}
    >
      {!showNavbar ? (
        <></>
          ...
          >
            ...
            <div className="flex -mt-2 justify-center items-center ">
              ...
              {isMobile ? (
                ...
                <div
                  onClick={onProfileCLick}
                  className=" text-white pr-5 mr-1 cursor-pointer w-[53px] sm:flex justify-center"
                >
                  {theme === "dark" || router.pathname.length === 1 ? (
                    <Image
            width={100}
          ...
          {sidebarOpen && (
            <div
              className={`${Style.overlay} overflow-y-auto ${
                theme === "dark" ||   router.pathname.length === 1 ? "bg-[#151515]" : "bg-[#fff]"
              } `}
            >
                ...
                <div className="flex flex-col gap-1" onClick={onProfileCLick}>
                  ...
                  <p
                    className={`${Style.signIn} ${
                      theme === "dark" ||  router.pathname.length === 1 ? "text-[#FFF]" : "text-[#000]"
                    }`}
                  >
                  ...
                  >
                    <div
                      className={`${Style.title}  ${
                        theme === "dark" ||  router.pathname.length === 1 ? "text-[#ffffff] " : "text-[#393939]"
                      } ${
                        router.pathname.split(`/`)[1] == eachItem.selected
                          ? "font-normal "
                          : "font-light "
