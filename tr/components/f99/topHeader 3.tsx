...
const TopHeader = () => {
    ...
    return (
        <div className={Style.escapeWrapper}>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:justify-between items-start lg:mt-5 sm:mr-20">
                <div className="">
                    <motion.div
                        ref={refMoon}
                        variants={boxVariant}
                    ...
                    >
                        <div className="flex flex-col">
                            <div className={`${Style.subhead1} mb-3 sm:mb-0`}>265 km/h</div>
